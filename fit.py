...
class Fit():
    ...
    def get_bias(self, nber_of_curves):
        """Getting bias by summing the best model of each narrow bin and fitting the sum with a bias power law model,
        containing an amplitude and an exponent, to the large bin;
